...
namespace BlankExtension2.Composers
{
    public class BlankExtension2ApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Blank Extension 2Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<BlankExtension2OperationSecurityFilter>();
            });
        }

        public class BlankExtension2OperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("BlankExtension2.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
