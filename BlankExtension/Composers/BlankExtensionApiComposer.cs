...
namespace BlankExtension.Composers
{
    public class BlankExtensionApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Blank Extension Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<BlankExtensionOperationSecurityFilter>();
            });
        }

        public class BlankExtensionOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("BlankExtension.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
