 ...
 *
 * Stock released Umbraco v17 only loads an example from a path RELATIVE to the client's
...
// The other half of the `external-extension-dev-support` work: stock v17 exposes the MSW
